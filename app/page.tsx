          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {[
                ...
                { title: "Adaptive Profile", text: "A 20-question one-at-a-time questionnaire shapes recommendations.", icon: Sparkles },
                { title: "Project Details", text: "Every Discover card opens a full project page.", icon: Compass },
              ].map((item) => {
              ...
              <div className="rounded-3xl border p-4" style={{ backgroundColor: themeStyles.panel, borderColor: themeStyles.border }}>
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="font-medium">Optional payment details</p>
                  </div>
                  <span
